...
public class NavDrawerActivity extends AppCompatActivity
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_laporan) {
            ...
            startActivity(new Intent(NavDrawerActivity.this, FixedNeedsActivity.class));
        }

        else if (id == R.id.nav_tdk_tetap) {
            startActivity(new Intent(NavDrawerActivity.this, UnfixedNeedsActivity.class));
        }
